...
'''
    ...
    def show_statistics_window(self, stats):
        ...
        # Create statistics display script
        script_content = f'''
import os
import sys
...
def show_stats():
    ...
    print(f"| Total duration:        {duration:.1f} minutes{' '*(27-len(str(int(duration)))-9)} |")
    print("|                                                    |")
    print(f"| Last connection:                                   |")
    print(f"|   {last_conn_str:<50} |")
    print("|                                                    |")
    print(f"| Recent history:        {history_count} entries{' '*(27-len(str(history_count))-8)} |")
    print("|                                                    |")
    print("+======================================================+")
    print("|                                                    |")

...
class NetSupportMonitorSimple:
    ...
    def update_tray_icon(self, connected: bool):
        ...
        if self.tray_icon:
            try:
                ...
                if connected:
                    self.tray_icon.title = "NetSupport Monitor - [!] LEERKRACHT VERBONDEN"
                else:
                    self.tray_icon.title = "NetSupport Monitor - [OK] Veilig"
            except Exception as e:
    ...
    def start_tray(self):
        ...
        try:
            ...
            menu = pystray.Menu(
                ...
                pystray.MenuItem("Instellingen", self.show_simple_settings),
    ...
    def run(self):
        ...
        print("[OK] NetSupport Monitor draait in system tray")
        print(">> Rechtsklik op tray icon voor opties")
